...
def classifier_train_test(df_train, df_test, classifier_type, output_folder,model_folder, args):
    ...
    model_save_dir = os.path.join(model_folder, classifier_type)
...
def main():
    ...
    df_X_train[args["image_path_field"]] = df_X_train[args["image_path_field"]].apply(
    ...
    classifier_train_test(
        ...
        model_folder=trained_models_folder,
        args=args,
    )
    set_seed(seed_val)
    classifier_train_test(
